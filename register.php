            ...
            <div class="col-lg-12">
                <div class="ltn__breadcrumb-inner">
                    ...
                    <div class="ltn__breadcrumb-list">
                        <ul>
                            <li><a href="/dento"><span class="ltn__secondary-color"><i class="fas fa-home"></i></span> Home</a></li>
                            <li>Register</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="account-login-inner">
                    <form action="" class="" method="POST" onsubmit="return validateForm()">
                        ...
                        <input class="" type="password" id="cpassword" name="cpassword" placeholder="Confirm Password*">
                        ...
                        <div class="btn-wrapper">
                            <button name="register-btn" type="submit" class="theme-btn-1 btn reverse-color btn-block" type="submit">CREATE ACCOUNT</button>
                        </div>
                    </form>
