        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area text-center">
                    <h1 class="section-title">Login to <br>Your Account</h1>
                ...
                <div class="account-login-inner">
                    <form action="" class="" method="POST" onsubmit="return validateForm()">
                        ...
                        <div class="btn-wrapper">
                            <button name="admin-login-btn" type="submit" class="theme-btn-1 btn reverse-color btn-block" type="submit">LOGIN</button>
                        </div>
                    </form>
                    <div class="by-agree text-center">
                        <p>By creating an account, you agree to our:</p>
                        <p><a href="terms-and-conditions">TERMS OF CONDITIONS  &nbsp; &nbsp; | &nbsp; &nbsp;  PRIVACY POLICY</a></p>
